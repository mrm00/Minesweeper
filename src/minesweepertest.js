...
const getNumberofNeighborBombs = (bombBoard, rowIndex, columnIndex) => {    //return the number of bombs in adjacent neighbors to user "click"
...
const printBoard= (board) => {  //so let's break this thing down. See comments below
